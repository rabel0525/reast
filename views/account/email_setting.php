<?php $this->setLayoutVar('title', 'メールアドレスの更新') ?>
...
<div class="contents">
    <div id="statues">
        <div class="container-left">
            <div id="posts">
<form action="<?php echo $base_url; ?>/account/change_email" method="post" enctype="multipart/form-data" style="
...
<p>変更に関する注意事項は利用規約をご覧ください。</p>
    ...
    <p>更新後のメールアドレス：<input type="text" name="new_email"></p>
    </div>
