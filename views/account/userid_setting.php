<?php $this->setLayoutVar('title', 'ユーザーID再設定') ?>
...
<div class="contents">
    <div id="statues">
        <div class="container-left">
            <div id="posts">
<form action="<?php echo $base_url; ?>/account/change_user_id" method="post" enctype="multipart/form-data" style="
...
">
    ...
    <?php endif; ?>
<h3>ユーザーID変更フォーム</h3>
<p>変更後、再ログインが必要になります。また、変更に関する注意事項は利用規約をご覧ください。</p>
    <div style="display:block;">
    <p>パスワード：<input type="password" name="password"></p>
    <p>変更後のユーザーID：<input type="text" name="new_user_name"></p>
    </div>
